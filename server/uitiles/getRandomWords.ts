...
import { Word } from "../interfaces/interface";
import arrayShuffle from "./arrayShuffle";
import classification from "./classification";


// this functoion will return 10 random words, and it must be not repated and have at 
const getRandomWords = (words : Array <Word>) : Array<Word> =>{


    let categorizedWords = classification(words);
    let randomWords : Array <Word> = [];
    ...
    return arrayShuffle(randomWords);
}
